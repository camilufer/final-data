...
document.getElementById('SCL20162').addEventListener('click', function() {
    ...
    //alumnas siguen en arequipa 2016 2
    var activasaqp = 0;
    var totalaqp = data.AQP["2016-2"].students;
    for (var i = 0; i < totalaqp.length; i++) {
        if (totalaqp[i].active == true) {
            activasaqp++;
        }
    }
...
document.getElementById('aqp20171').addEventListener('click', function) {
    var dropoutaqp1 = 0;
//alumnas que siguen en AQP
var 
}
